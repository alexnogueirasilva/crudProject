<x-app-layout>
    ...
    <svg class="fill-current h-6 w-6 text-red-500" role="button" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><title>{{ __('Close') }}</title><path
                                ...
                                <div class="px-4 py-5 bg-white sm:p-6">
                                    ...
                                    <div class="px-4 py-3 bg-gray-50 text-right sm:px-6">
                                        <button
                                            ...
                                            <a href="{{ route('product.index') }}">  {{ __('Back') }}</a>
                                        </button>
                                        <button type="submit"
